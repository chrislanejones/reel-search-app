...
>
	<input
		...
		bind:value={query}
		oninput={onInput}
		class="w-56 bg-transparent px-3 py-2 text-sm text-neutral-100
		placeholder:text-neutral-400 focus:outline-none"
	/>

	<button
		type="submit"
		class="border-l border-neutral-700 bg-neutral-700 px-4 py-2 text-sm
		font-medium text-neutral-100 hover:bg-neutral-600"
	>
		Search
	</button>
</form>
